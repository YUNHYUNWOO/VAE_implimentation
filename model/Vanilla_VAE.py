...
class Decoder(nn.Module):
    ...
    def __init__(self, 
        ...
        self.to_2d_layer = nn.Sequential(nn.Linear(in_features=latent_shape, out_features=flatten_shape), 
...
class Vanilla_VAE(nn.Module):
    ...
    def loss_fn(self, sample: torch.Tensor, x: torch.Tensor, mean: torch.Tensor, log_var: torch.Tensor):
        ...
        log_info = {'loss' : loss.item(), 
                    'prior_matching_loss': (self.kld_weight * prior_matching_loss).item(),
